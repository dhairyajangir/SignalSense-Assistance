...
export const Conversation: React.FC = () => {
    const { isConnecting, isConnected, transcript, error, startSession, endSession } = useLiveSession();
    ...
    return (
        <div className="flex flex-col h-full">
            ...
            <div className="flex items-center justify-center gap-4">
             ...
             {isConnected && <div className="text-center mt-3 text-green-600 font-medium text-sm">Microphone is active</div>}
        </div>
    );
};
